  ...
  return (
    <div
      ...
      <div
        ...
        className={`rounded-lg py-[14px] px-4 h-max w-[800px] flex justify-center glass items-center overflow-y-auto transition-transform duration-300 ${isRegModalAct ? 'scale-100' : 'scale-95'}`}>
